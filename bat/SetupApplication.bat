...
:: Android packaging
set AND_CERT_NAME="Away3D"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\Away3D.p12
...
set IOS_PROVISION=cert\Away3D.mobileprovision
...
set APP_ID=air.com.makemultimedia.away3d.Away3D

:: Output packages
set DIST_PATH=dist
set DIST_NAME=Away3D
